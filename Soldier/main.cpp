...
int main()
{
	...
	while (1)
	{
		cout << "\nВыберите нужную операцию: 1 - добавить солдатов в отряд, 2 - исключить солдата из отряда по имени, 3 - вывести информацию об отряде, 4 - исключить из отряда всех убитых солдат, 5 - провести битву, 6 - записать данные в файл, 7 - считать данные из файла, 0 - выход из программы" << endl;
		cin >> enter;
		...
		case 5:
			...
			break;
		case 6:
			detachment.WriteToFile();
			break;
		case 7:
			detachment.ReadFromFile();
			break;
