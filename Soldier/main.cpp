...
int main()
{
	...
	while (1)
	{
		cout << "\nВыберите нужную операцию: 1 - добавить солдатов в отряд, 2 - исключить солдата из отряда по имени, 3 - вывести информацию об отряде, 4 - исключить из отряда всех убитых солдат, 5 - провести битву, 0 - выход из программы" << endl;
		cin >> enter;
